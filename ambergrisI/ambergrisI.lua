...
function rp2040_display_stop()
    out_midi:note_off(params:get("note_grn"))
    out_midi:note_on(params:get("note_red"))
end

function rp2040_display_start()
    out_midi:note_on(params:get("note_grn"))
end

function rp2040_display_switch()
  out_midi:note_on(params:get("note_blu"))
end

function all_notes_off()
  out_midi:note_off(params:get("note_red"))
  out_midi:note_off(params:get("note_grn"))
  out_midi:note_off(params:get("note_blu"))
end
